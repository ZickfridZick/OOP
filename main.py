...
some_reviewer = Reviewer('Rito', 'Pliz')
some_reviewer.courses_attached += ['Python', 'Git']

reviewer_2 = Reviewer('Max', 'Stack')
...
print(f'Средняя оценка   William Mandarin больше чем у  Vex Evelin ?: {student_best.__lt__(student_2)}')
print(f'Средняя оценка у лектора David Martinez меньше чем у Adam Smasher ?: {cool_lecturer.__lt__(lecturer_2)}')
